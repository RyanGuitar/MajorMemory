function setSounds2(){
  import('../scripts/aggregator.js')
      .then(({elAdd, addClickId, setSounds1, setRainSoundsIntro, setImages1}) => {
      ...
      <p id="hint">Click on numbers for more information</p>
        <div id="navBox">
           <div id="back">back</div>
           <div id="play">Play Raining Sounds</div>
        ...
        function goBack(){
          ...
          addClickId('next', setRainSoundsIntro)
          addClickId('play', setRainSoundsIntro)
          addTableListener()
        }
